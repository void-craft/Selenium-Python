...
### Project_1
#### BBC_Webscraping - POM
This Page Object Model (POM) implemented script written in Python Programming Language uses Selenium to open a browser, navigate to the BBC News website, reject cookies, click on various links to go to the India news section, and print the news headlines from the page.
